...
function generateObjectKey(entityType, entityId, originalName) {
...
export class UploadService {
     ...
     */
    async uploadFile(file, bucket, entityType, entityId, uploadedBy) {
     ...
     */
    async uploadMultiple(files, bucket, entityType, entityId, uploadedBy) {
        const results = [];
     ...
     */
    getFileUrl(bucket, objectKey, isPublic) {
        if (isPublic) {
     ...
     */
    async getFileUrlAsync(bucket, objectKey, isPublic) {
        if (isPublic) {
            return `${MINIO_PUBLIC_URL}/${bucket}/${objectKey}`;
        }
