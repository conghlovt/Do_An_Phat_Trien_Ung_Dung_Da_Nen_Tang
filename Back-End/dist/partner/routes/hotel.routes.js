...
publicRouter.get('/', asyncHandler((req, res) => hotelController.listPublic(req, res)));
/** GET /api/v1/hotels/:slug — Hotel detail by slug (public) */
publicRouter.get('/:slug', asyncHandler((req, res) => hotelController.getPublic(req, res)));
...
partnerRouter.get('/', validate(hotelQuerySchema, 'query'), asyncHandler((req, res) => hotelController.listMyHotels(req, res)));
/** POST /api/v1/partner/hotels — Create hotel */
partnerRouter.post('/', validate(createHotelSchema), asyncHandler((req, res) => hotelController.create(req, res)));
/** GET /api/v1/partner/hotels/:id — Get my hotel detail */
partnerRouter.get('/:id', asyncHandler((req, res) => hotelController.getMyHotel(req, res)));
/** PUT /api/v1/partner/hotels/:id — Update my hotel */
partnerRouter.put('/:id', validate(updateHotelSchema), asyncHandler((req, res) => hotelController.update(req, res)));
/** POST /api/v1/partner/hotels/:id/submit — Submit for review */
partnerRouter.post('/:id/submit', asyncHandler((req, res) => hotelController.submitForReview(req, res)));
/** DELETE /api/v1/partner/hotels/:id — Delete hotel */
partnerRouter.delete('/:id', asyncHandler((req, res) => hotelController.delete(req, res)));
// ---- Image Upload ----
/** POST /api/v1/partner/hotels/:id/images — Upload hotel images (max 10) */
partnerRouter.post('/:id/images', uploadMultipleImages, asyncHandler((req, res) => hotelController.uploadImages(req, res)));
/** DELETE /api/v1/partner/hotels/:id/images/:imageId — Delete hotel image */
partnerRouter.delete('/:id/images/:imageId', asyncHandler((req, res) => hotelController.deleteImage(req, res)));
// ---- Video Upload ----
/** POST /api/v1/partner/hotels/:id/videos — Upload hotel video */
partnerRouter.post('/:id/videos', uploadSingleVideo, asyncHandler((req, res) => hotelController.uploadVideo(req, res)));
/** DELETE /api/v1/partner/hotels/:id/videos/:videoId — Delete hotel video */
partnerRouter.delete('/:id/videos/:videoId', asyncHandler((req, res) => hotelController.deleteVideo(req, res)));
