...
export const styles = StyleSheet.create({
  ...
  countdownLabel: { fontSize: 12, fontWeight: '700', color: '#92400e' },
  countdownTimer: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  timeUnit: {
    backgroundColor: '#111827', borderRadius: 6,
    paddingHorizontal: 7, paddingVertical: 3, minWidth: 28, alignItems: 'center',
  },
  timeNum: { color: '#fff', fontSize: 14, fontWeight: '800', fontVariant: ['tabular-nums'] },
  timeSep: { color: '#111827', fontSize: 15, fontWeight: '800' },
  // Tab bar
  tabBar: {
