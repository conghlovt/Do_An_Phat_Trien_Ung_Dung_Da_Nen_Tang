...
export default function Banners() {
    ...
    return (
        <View style={[styles.coupon, {
            ...
            <Text style={[styles.couponText, { color: currentTheme.text }]}>Voucher giảm giá đang chờ bạn sử dụng.</Text>
            <Pressable style={styles.couponBtn} onPress={() => router.push('/customer/voucher/wallet' as any)}>
                <Text style={styles.couponBtnText}>Xem voucher</Text>
            </Pressable>
        </View>
    );
}
