        ...
        <>
            ...
            <View style={[
                ...
                isScrolled
                    ...
                    : [styles.notScrolled, { backgroundColor: 'rgba(133,194,164,0.14)' }],
            ]}>
                <View style={styles.webInner}>
                    {!isScrolled && (
                        <View style={[styles.topRow, styles.webTopRow]}>
                            <View style={styles.brandBlock}>
                                ...
                                <Text style={[styles.subtitle, styles.webSubtitle, { color: currentTheme.textSecondary }]}>Khám phá khách sạn và ưu đãi tại</Text>
                                ...
                                >
                                    ...
                                    <Text style={[styles.location, styles.webLocation, { color: STAYHUB_COLOR }]} numberOfLines={1}>
                                        {locationLabel}
                                    </Text>
                    ...
                    <View style={[styles.searchRow, styles.webSearchRow]}>
                        <Pressable style={[styles.searchBar, styles.webSearchBar, { backgroundColor: currentTheme.card, borderColor: 'rgba(133,194,164,0.45)' }]} onPress={onOpenSearch}>
                            <Search size={20} color={PRIMARY} />
                            <Text style={[styles.searchPlaceholder, styles.webSearchPlaceholder, { color: currentTheme.textSecondary }]}>Tên khách sạn, hoặc quận...</Text>
                        </Pressable>
                        {isScrolled && (
