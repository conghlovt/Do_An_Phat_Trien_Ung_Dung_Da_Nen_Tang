...
import { useLocationContext, Province } from '@/src/customer/context/LocationContext';
    ...
    >
      <View
        style={[
          ...
          { paddingTop: isWebLayout ? 0 : insets.top || 20 },
        ]}
      >
        {/* Header */}
        ...
        <View style={styles.locationBar}>
          <View style={styles.currentLocation}>
            <MapPin size={17} color={STAYHUB_COLOR} strokeWidth={2.5} />
