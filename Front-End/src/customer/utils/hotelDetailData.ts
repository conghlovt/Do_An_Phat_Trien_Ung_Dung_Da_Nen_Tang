...
export function enrichHotel(hotel: Hotel): Hotel {
  return {
    ...
    phone: hotel.phone ?? '0845 795 656',
    address: hotel.address ?? 'Căn hộ số 30-N7B, Khu đô thị Trung Hòa-Nhân Chính, phường Nhân Chính, quận Thanh Xuân, Hà Nội',
    description: hotel.description ?? 'Mọi vấn đề liên quan đến khách sạn, quý khách vui lòng gọi điện theo số hotline của chúng tôi.',
    amenities: hotel.amenities?.length ? hotel.amenities : ['WiFi', 'Điều hòa', 'TV', 'Bồn tắm', 'Cà phê'],
