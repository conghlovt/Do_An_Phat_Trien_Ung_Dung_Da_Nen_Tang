...
import { hotelsApi, TimeSlot, BookingType } from '@/src/customer/services/hotels/hotels.api';
import {
  HOUR_OPTIONS,
  MONTH_LABELS,
  WEEKDAYS,
} from '@/src/customer/constants/booking/bookingDate.constants';
import {
  addDays,
  ...
  startOfDay,
} from '@/src/customer/utils/booking/bookingDate.utils';
import { BOOKING_TYPES, formatShortDate } from '@/src/customer/utils/booking/booking';
import {
  bookingCalendarScreenStyles as styles,
  PRIMARY,
  PRIMARY_DARK,
} from '@/src/customer/styles/booking/bookingCalendarScreen.styles';
...
export default function BookingCalendarScreen() {
  ...
  const requestedBookingType = params.bookingType as BookingType;
  const initialBookingType = BOOKING_TYPES.includes(requestedBookingType) ? requestedBookingType : 'Theo giờ';
  ...
  const handleApply = async () => {
    ...
    const returnPath = returnTo === 'room-list' ? '/customer/hotels/rooms' : '/customer/hotels/[id]';
