...
} from '@/src/customer/utils/booking/customerBookings';
...
export default function BookingDetailScreen() {
  ...
  const isPendingPayment = booking?.status === 'Đang chờ xử lý';
    ...
    booking?.paymentMethod === 'PAY_AT_HOTEL'
      ...
      : booking?.paymentStatus === 'PAID'
        ...
        : booking?.paymentStatus === 'CANCELLED'
          ? 'Đã hủy'
          : booking?.paymentStatus === 'EXPIRED_FINAL' || booking?.paymentStatus === 'PAYMENT_NOT_RECORDED'
      ...
      >
        <View style={isWebLayout && styles.webContent}>
            ...
            <View style={styles.statusTextBlock}>
              ...
              <Text style={styles.statusSubtitle}>
                {isCancelled
                  ...
                  : booking.status === 'Không ghi nhận thanh toán'
                    ? 'Hệ thống chưa ghi nhận được thanh toán tự động. Vui lòng liên hệ hỗ trợ nếu bạn đã chuyển khoản.'
                  : isPendingPayment
                    ? 'Booking đang chờ xác nhận thanh toán từ ngân hàng.'
          ...
          <View style={[styles.section, isWebLayout && styles.webSection, isWebLayout && styles.webGridSection, { backgroundColor: currentTheme.card, borderColor: currentTheme.border }]}>
            ...
            <View style={styles.infoRow}>
              ...
              <View style={styles.paymentStatus}>
                <Text style={[styles.infoValue, { color: currentTheme.text }]}>{paymentStatusText}</Text>
          ...
          <View style={[styles.section, isWebLayout && styles.webSection, isWebLayout && styles.webGridSection, { backgroundColor: currentTheme.card, borderColor: currentTheme.border }]}>
            ...
            <Pressable style={styles.supportRow} onPress={() => router.push('/customer/support/contact' as any)}>
