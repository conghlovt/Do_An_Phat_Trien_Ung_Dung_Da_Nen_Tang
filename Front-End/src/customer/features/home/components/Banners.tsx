  ...
  return (
    <View style={[styles.container, isWebLayout && styles.webContainer]}>
      {!isLoading && !isAuthenticated ? (
        <View style={[styles.coupon, isWebLayout && styles.webCoupon, {
          ...
          <Pressable style={styles.couponBtn} onPress={() => router.push('/login' as any)}>
      ...
      {/* Campaign Banner */}
      <Pressable style={[styles.campaign, isWebLayout && styles.webCampaign]}>
        <ImageWithFallback
