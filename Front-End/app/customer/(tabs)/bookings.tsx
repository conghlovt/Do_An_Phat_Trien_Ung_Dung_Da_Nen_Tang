...
import { customerBookingsStorage, type CustomerBooking } from '@/src/customer/utils/customerBookings';
      ...
      <ScrollView contentContainerStyle={[styles.scrollContent, isWebLayout && styles.webScrollContent]}>
        ...
        {isWebLayout && (
          <View style={styles.webTitleRow}>
            ...
            <Pressable style={[styles.webFilterBtn, { backgroundColor: currentTheme.card, borderColor: currentTheme.border }]}>
              <SlidersHorizontal size={20} color={currentTheme.textSecondary} />
            </Pressable>
          </View>
        )}
