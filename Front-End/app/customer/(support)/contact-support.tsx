...
import { Platform, View, Text, StyleSheet, Pressable, ScrollView, Linking, ActivityIndicator, useWindowDimensions } from 'react-native';
import { useSafeAreaInsets } from 'react-native-safe-area-context';
import { ArrowLeft, MapPin } from 'lucide-react-native';
import { useThemeContext } from '@/src/customer/shared/theme/ThemeContext';
import { hotelsApi, type OfficeInfo } from '@/src/customer/features/hotels/api/hotels.api';
import { useCustomerBack } from '@/src/customer/shared/navigation/useCustomerBack';
import { CONTACT_ITEMS } from '@/src/customer/features/support/constants/contactSupport';
...
export default function ContactSupportScreen() {
  ...
  useEffect(() => {
    hotelsApi.getOfficeInfo()
      .then((result) => setOfficeInfo(result.data))
      .catch(() => {})
  ...
  return (
    <View style={[styles.container, isWebLayout && styles.webContainer, { backgroundColor: currentTheme.background, paddingTop: isWebLayout ? 0 : insets.top }]}>
      ...
      <ScrollView
        ...
        contentContainerStyle={isWebLayout && styles.webContent}
