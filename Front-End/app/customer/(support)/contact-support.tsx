...
import { SUPPORT_ACCENT, supportStyles as styles } from '@/src/customer/components/support/support.styles';
import { CONTACT_ITEMS } from '@/src/customer/constants/contactSupport';
import { useOfficeInfo } from '@/src/customer/hooks/useOfficeInfo';
