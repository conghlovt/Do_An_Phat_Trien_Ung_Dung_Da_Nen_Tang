...
import {
  ThemeProvider,
  useThemeContext,
} from "@/src/customer/theme/ThemeContext";
import { LocationProvider } from "@/src/customer/context/LocationContext";
import { VoucherCollectProvider } from "@/src/customer/context/VoucherCollectContext";
...
const WEB_NAV_ITEMS = [
  ...
  },
  {
    ...
    label: "Khám phá",
    Icon: Compass,
    match: ["/customer/discover"],
  },
  {
    href: "/customer/bookings",
    label: "Phòng đã đặt",
    Icon: ClipboardList,
    match: ["/customer/bookings", "/customer/booking"],
  },
  {
    href: "/customer/offers",
    label: "Ưu đãi",
    Icon: Gift,
    match: ["/customer/offers"],
  },
  {
...
function ResponsiveAppWrapper({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <CustomerWebShellProvider
        value={{ isWebLayout, sidebarWidth: isWebLayout ? sidebarWidth : 0 }}
      >
        {isWebLayout && (
          <View
            style={[
          ...
          >
            <View
              style={[styles.webHeader, collapsed && styles.webHeaderCollapsed]}
            >
              <View
                style={[
                  styles.webBrandRow,
            ...
            <View
              style={[
                styles.webDivider,
                collapsed && styles.webDividerCollapsed,
            ...
            <View
              style={[
                styles.webNavList,
                collapsed && styles.webNavListCollapsed,
              ]}
            >
              {WEB_NAV_ITEMS.map(({ href, label, Icon, match }) => {
                const isActive = match.some((item) =>
                ...
                return (
                  ...
                  >
                    <View
                      style={[
                        styles.webIconBox,
                        isActive && styles.webIconBoxActive,
                      ]}
                    >
                      <Icon
                        size={21}
                    ...
                    {!collapsed && (
                      <Text
                        style={[
                          styles.webTabLabel,
                          { color: isActive ? PRIMARY_DARK : "#64748b" },
                        ]}
                        numberOfLines={1}
                      >
                        {label}
            ...
            {isAuthenticated && (
              <View
                style={[
                  styles.webSidebarActions,
                  collapsed && styles.webSidebarActionsCollapsed,
                ]}
              >
                <Pressable
                  onPress={handleLogout}
                  style={[
                    styles.webLogoutItem,
                    collapsed && styles.webLogoutItemCollapsed,
                  ]}
                >
            ...
            <Pressable
              ...
              style={[
                styles.webToggleBtn,
                collapsed && styles.webToggleBtnCollapsed,
              ]}
            >
              {collapsed ? (
              ...
              >
                ...
                {!collapsed && (
                  <View style={styles.webAccountButtonText}>
                    <Text
                      style={[styles.webUserName, { color: currentTheme.text }]}
                      numberOfLines={1}
                    >
                      {displayName}
                    </Text>
  ...
  return (
    <Stack initialRouteName="(tabs)" screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        ...
        options={fullScreenRightOptions}
      />
      <Stack.Screen
        name="messages/notification-settings"
        options={{ animation: "slide_from_right" }}
      />
      <Stack.Screen
